...
(function() {
    ...
    LuShu.prototype.start = function() {
        ...
        if (me.i >=0 && me.i < len - 1) {
            ...
            if (!me._fromPause) {
	            ...
	            //me._moveNext(++me.i);
                var j = me.i;
                me._move( me._marker.getPosition(), me._path[++j], me._tween.linear);
            }
        }else {
            $(document).trigger('lushu_movestart');
    ...
    baidu.object.extend(LuShu.prototype, {
        ...
        _move: function(initPos,targetPos,effect) {
            $(document).trigger("lushu_movepoint", initPos);
            var me = this,
                //当前的帧数
                currentCount = 0,
                //步长，米/秒
        ...
        */
        ...
        _moveNext: function(index) {
            ...
            if (index < this._path.length - 1) {
                ...
                $(document).trigger("lushu_movestop");
            }
        },
        /**
